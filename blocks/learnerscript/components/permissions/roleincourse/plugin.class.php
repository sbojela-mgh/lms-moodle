...
class plugin_roleincourse extends pluginbase {
    ...
    public function init() {
        ...
        $this->reporttypes = array( 'courses', 'sql', 'ls_users', 'statistics', 'timeline', 'categories', 'activitystatus', 'listofactivities', '  coursesoverview', 'usercourses', 'grades','scorm_activities_course', 'competencycompletion', 'myassignments', 'useractivities',
                                    ...
                                    'resources_accessed', 'timespent','noofviews', 'forum', 'assignstatus', 'myforums', 'courseprofile', 'userattendance', 'attendanceoverview', 'courseactivities', 'courseviews','coursesoverview');
    }
