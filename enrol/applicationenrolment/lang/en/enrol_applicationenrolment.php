...
$string['emailtemplate_submitted']      = 'Email template (submitted)';
...
$string['emailtemplate_deniedcontent']	= 'Dear [Student First Name],<br><br>Thank you for your interest in [Course Fullname]. On this occasion, we have decided not to take your [HYPERLINK_APPLICATION_FORM] further.<br><br>We encourage you to reapply next time and check out our other course offerings <a href="https://opencourses.partners.org">https://opencourses.partners.org</a>.<br><br>Thank you,<br>Division of Clinical Research, Center for Clinical Research Education';
<<<<<<< HEAD
$string['emailtemplate_remindercontent'] = 'Dear [Student First Name],<br><br>Thank you for starting your application. To be considered for [Course Fullname], please finish your application here: [Course URL].<br><br>The deadline to complete your application is [Due Date].<br><br>Questions with an asterisk next to them must be filled in. Make sure you complete all required questions.<br><br>If you have any questions, please reply to this <a href="mailto:DCRCCRE@partners.org">email</a>.<br><br>Thank you,<br>Division of Clinical Research, Center for Clinical Research Education';
$string['emailtemplate_submitconfirm'] = 'Dear [Student First Name],<br><br>Thank you for submitting your application for [Course Fullname] this year. We are looking forward to reviewing your application.<br><br>Please visit the course page [Hyperlink Course URL] for application status updates. You will receive an email once a decision has been made.<br><br>If you have any questions, please reply to this <a href="mailto:DCRCCRE@partners.org">email</a>.<br><br>Thank you,<br>Division of Clinical Research, Center for Clinical Research Education';
=======
$string['emailtemplate_remindercontent'] = 'Dear [Student First Name],<br><br>Thank you for starting your application. To be considered for [Course Fullname], please finish your application here: [Course URL].<br><br>The deadline to complete your application is [Due Date].<br><br>Questions with an asterisk next to them must be filled in. Make sure you complete all required questions.<br><br>If you have any questions, please reply to this <a href="email:DCRCCRE@partners.org">email</a>.<br><br>Thank you,<br>Division of Clinical Research, Center for Clinical Research Education';
$string['emailtemplate_submitconfirm'] = 'Dear [Student First Name],<br><br>Thank you for submitting your application for [Course Fullname] this year. We are looking forward to reviewing your application.<br><br>Please visit the course page [Hyperlink Course URL] for application status updates. You will receive an email once a decision has been made.<br><br>If you have any questions, please reply to this <a href="email:DCRCCRE@partners.org">email</a>.<br><br>Thank you,<br>Division of Clinical Research, Center for Clinical Research Education';
